		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form:form action="/addVillage" method="POST" modelAttribute="villages">
						<div class="form-group">
							<form:select class="form-control" path="city" id="exampleFormControlSelect1" placeholder="City">
								<c:forEach items="${cities}" var="city">
									<form:option value="${city}"><c:out value="${city.name}"/></form:option>
								</c:forEach>
							</form:select>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<form:input type="number" path="space" class="form-control" id="exampleFormControlInput1" placeholder="Village Area" />
						</div>
						<div class="form-group">
							<form:input type="number" path="population" class="form-control" id="exampleFormControlInput1" placeholder="Population" />
						</div>
						<div class="form-group">
